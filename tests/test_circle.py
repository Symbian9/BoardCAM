...
class TestCircle(unittest.TestCase):
    ...
    def test_belong(self):
        self.assertTrue(self.c.belong(Point3D(4, 8)))
        self.assertFalse(self.c.belong(Point3D(4, 9)))
    #
    ...
    #                      [circle.Circle(0), circle.Circle(1), circle.Circle(2), circle.Circle(3), circle.Circle(
    #                          4), circle.Circle(5), circle.Circle(6), circle.Circle(7), circle.Circle(8),
    #                       circle.Circle(9)])
